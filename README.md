...
Once you have executed `npm run build-sass`, follow these steps to load the extension in a Chromium-based browser:
  ...
  3. Go to the extensions section in the browser settings.
     
  5. Enable "Developer Mode" at the top right of the page.
  <img width="100%" src="https://cdn.discordapp.com/attachments/606233142021324816/1127379223909244928/installation_1.png">

  7. Click on the "Load unpacked" button and select the **dist folder** from the project.
  <img width="50%" src="https://cdn.discordapp.com/attachments/606233142021324816/1127378248133787818/installation_2.png">
